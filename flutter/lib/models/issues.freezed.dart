...
class _$_IssuesSearchCondition
    with DiagnosticableTreeMixin
    implements _IssuesSearchCondition {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'IssuesSearchCondition'))
      ..add(DiagnosticsProperty('repository', repository))
      ..add(DiagnosticsProperty('issuesPerPage', issuesPerPage))
      ..add(DiagnosticsProperty('milestoneNumber', milestoneNumber))
